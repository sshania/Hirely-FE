  ...
  const goToProfile = () => {
    ...
    <div className="min-h-screen w-screen bg-gray-100 font-sans flex flex-col">
        ...
        <div className="flex items-center space-x-3">
            <img src="HirelyLogo.png" alt="Hirely Logo" className="h-16" /> {/* Bigger logo */}
        ...
        <div className="bg-green-800 bg-opacity-80 p-16 rounded-xl shadow-xl text-center text-white max-w-4xl w-full">
            ...
            <button onClick={startMatching} className="bg-white text-green-700 px-8 py-3 rounded-full font-medium hover:bg-gray-200">Start Matching!</button>
        </div>
        </main>
